...
public interface AddressRepository extends JpaRepository<AddressEntity, Long> {
    ...
    @Query("select new com.sda.project.bookingwebapp.model.TopDestinationModel(count(a.city),a.city,a.country) from AddressEntity a group by a.city,a.country order by count(a.city) desc ")
